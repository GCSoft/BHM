<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/LoginTemplate.Master" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="BHM.Web.Application.WebApp.Public.frmLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntLoginBody" runat="server">
    ...
    <asp:Panel ID="pnlLogin" runat="server" Style="background-color: #E5E9EC; width: 310px;">
        ...
        <asp:collapsiblepanelextender id="cpeOptions" runat="Server" targetcontrolid="pnlCollapseBody" collapsed="true" collapsedtext="Opciones" expandedtext="Ocultar" textlabelid="lblCollapseHeader" expandcontrolid="pnlCollapseHeader" collapsecontrolid="pnlCollapseHeader" suppresspostback="true" />
        <asp:dropshadowextender id="dseLogin" runat="server" targetcontrolid="pnlLogin" width="0" rounded="true" radius="6" opacity=".75" trackposition="true" />
